...
class SR_Matrix_HTTP():
    ...
    def __init__(self):
        ...
        :param ip: AGV IP
        """
        self.ip = '192.168.33.158'
        self.logger = logging('SR_Matrix_HTTP')
    ...
    def delete_mission_task(self, mission_id: int):
        ...
        try:
            ...
            self.logger('delete_mission_task:' + str(e))
    ...
    def clear_mission_record(self):
        ...
        try:
            ...
            self.logger.error('clear_mission_record: {}'.format(e))
    ...
    def get_map_list(self):
        ...
        try:
            ...
            self.logger.error('get_map_list:' + str(e))
    ...
    def get_map_json(self, map_name: str):
        ...
        try:
            ...
            self.logger.error('get_map_json:' + str(e))
    ...
    def get_map_image(self, map_name: str):
        ...
        try:
            ...
            self.logger.error('get_map_image:' + str(e))
    ...
    def get_task_template(self):
        ...
        try:
            ...
            self.logger.error('get_task_template: ' + str(e))
    ...
    def get_mission_plan(self):
        ...
        try:
            ...
            self.logger.error('get_mission_plan:' + str(e))
    ...
    def export_task(self, task_id: int):
        ...
        try:
            ...
            self.logger.error('export_task: {}'.format(e))
    ...
    def get_account_management_list(self):
        ...
        try:
            ...
            self.logger.error('get_account_management_list:' + str(e))
    ...
    def map_file_FMS_export(self, map_name: str):
        ...
        try:
            ...
            self.logger.error('map_file_export:' + str(e))
    ...
    def map_file_FMS_import(self, map_address='') -> str:
        ...
        try:
            ...
            self.logger.error('map_file_FMS_import:' + str(e))
    ...
    def get_config_parameter_list(self):
        ...
        try:
            ...
            self.logger.error(' get_config_parameter_list:' + str(e))
    ...
    def get_single_config_parameter(self, parameter_id: int):
        ...
        try:
            ...
            self.logger.error('get_single_config_parameter:' + str(e))
    ...
    def modify_single_parameter(self, parameter_id: int, modify_parameter: dict):
        ...
        try:
            ...
            self.logger.error('modify_single_parameter:' + str(e))
    ...
    def SRC_firmware_upgrade(self, firmware_address='') -> str:
        ...
        try:
            ...
            self.logger.error('SRC_firmware_upgrade:' + str(e))
    ...
    def SROS_firmware_rollback(self):
        ...
        try:
            ...
            self.logger.error('SROS_firmware_rollback:' + str(e))
    ...
    def get_system_startup_log(self, limit: int, offset=0):
        ...
        try:
            ...
            self.logger.error('get_system_startup_log:' + str(e))
    ...
    def get_system_log(self, lines: int):
        ...
        try:
            ...
            self.logger.error('get_system_log:' + str(e))
    ...
    def export_log(self):
        ...
        try:
            ...
            self.logger.error('export_log:' + str(e))
    ...
    def export_debug_log(self):
        ...
        try:
            ...
            self.logger.error('export_debug_log:' + str(e))
    ...
    def export_config_db(self):
        ...
        try:
            ...
            self.logger.error('export_config_db:' + str(e))
    ...
    def import_config_db(self, db_address='') -> str:
        ...
        try:
            ...
            self.logger.error('import_config_db:' + str(e))
    ...
    def import_logo(self, logo_address=''):
        ...
        try:
            ...
            self.logger.error('map_logo:' + str(e))


if __name__ == '__main__':
    agv_53 = SR_Matrix_HTTP()
    agv_53.login('admin')
