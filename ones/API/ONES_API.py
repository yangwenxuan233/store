...
class OnesAPI:
    ...
    def getTestPlanInfo(self,planName:str):
        """
        获取测试计划详细信息
        ...
        """
        try:
            planList = json.loads(self.getTestPlanList())['plans']
            for plan in planList:
                if plan['name'] == planName:
                    return plan
        except BaseException as e:
            self.logger.error(f'getTestPlanInfo:{e}')

    def getTestPlanDetails(self,planName:str)->dict:
        """
        获取测试计划详细信息，包含状态，关联迭代，测试计划属性，测试报告等信息
        :param planName:测试计划名称
        :return:
        """
        try:
            planUuid = self.getTestPlanInfo(planName)['uuid']
            ...
            return ret.json() # 返回详细测试计划信息
        except BaseException as e:
            self.logger.error('getTestPlanDetails:' + str(e))
    ...
    def getTestCaseListName(self,testPlanName)->list:
        ...
        try:
            ...
            for testcase in getList:
                TestCaseList.append({"plan_uuid":testcase['plan_uuid'],"uuid":testcase['uuid'],"number":testcase['number'],"name":testcase['name'],"executor":testcase['executor']})
            return TestCaseList
        except BaseException as e:
            self.logger.error('getTestCaseList:' + str(e))
        ...
        try:
            ...
            for i in testplan_list:
                if i['name'] == testplan:
                    ...
                    ret = requests.post(url=request_URL, headers=headers, data=json.dumps(testcase).encode("utf-8"))
                    return ret.json()
            return '没有找到相关测试用例！'
        except BaseException as e:
    ...
    def uploadAttachmentToCase(self, fileAddress: str, caseUuid:str,fileName: str, description: str,):
        ...
        try:
            ...
            request = {
                ...
                'name': fileName,
                'ref_id': self.getCaseRefId(caseUuid), # 获取ref_id
                'ref_type': 'plan_case',
                'type': 'attachment'
            }
            ret = requests.post(url=request_URL, headers=headers, json=request)
    ...
    def getCaseDetails(self,caseUuid:str):
        """
        通过graphql接口获取用例详细信息，可以通过这个接口拿到case附件上传ref_id
        :param caseUuid:测试用例uuid
        :return:
        """
        try:
            # 上传资源
            request_URL = f'https://ones.standard-robots.com/project/api/project/team/{self.teams_uuid}/items/graphql'
            headers = {
                'Ones-Auth-Token': self.user_token,
                'Ones-User-Id': self.user_uuid,
            }
            request = {
                        "query": "query PAGED_TESTCASE_PLAN_CASE_LIST($testCaseFilter: Filter, $planFilter: Filter, $moduleFilter: Filter, $orderByFilter: Filter) {\n  buckets(groupBy: {testcasePlanCases: {}}, pagination: {limit: 50, around: \"testcase_plan_case-Bpbpr931-B17gmvPQ\", preciseCount: false}) {\n    key\n    testcasePlanCases(filterGroup: $testCaseFilter, orderBy: $orderByFilter, limit: 10000) {\n      inCaseUUID\n      testcaseCase {\n        uuid\n        name\n        namePinyin\n        key\n        condition\n        createTime\n        desc\n        number\n        path\n        assign {\n          uuid\n          name\n        }\n        testcaseLibrary {\n          uuid\n          testcaseFieldConfig {\n            uuid\n            name\n          }\n        }\n        testcaseModule {\n          uuid\n          path\n        }\n        priority {\n          uuid\n        }\n        type {\n          uuid\n        }\n        relatedWikiPage\n      }\n      key\n      note\n      result\n      executor {\n        uuid\n        name\n      }\n    }\n    key\n    pageInfo {\n      count\n      totalCount\n      startPos\n      startCursor\n      endPos\n      endCursor\n      hasNextPage\n      unstable\n    }\n  }\n  testcasePlans(filter: $planFilter) {\n    key\n    uuid\n    owner {\n      uuid\n      name\n    }\n    name\n    namePinyin\n    createTime\n    status {\n      name\n      uuid\n      category\n    }\n    members {\n      type\n      param\n    }\n    planStage {\n      value\n    }\n    relatedProject {\n      key\n      uuid\n      name\n      namePinyin\n    }\n    relatedSprint {\n      key\n      uuid\n      name\n      namePinyin\n    }\n    relatedIssueType {\n      key\n      uuid\n      name\n      namePinyin\n      detailType\n    }\n    assigns {\n      uuid\n      name\n    }\n    todoCaseCount\n    passedCaseCount\n    blockedCaseCount\n    skippedCaseCount\n    failedCaseCount\n    planReports {\n      uuid\n      name\n    }\n    checkPoints\n  }\n  fields(filter: {hidden_in: [false], pool_in: [\"testcase\"], context: {type_in: [\"team\"]}}, orderBy: {builtIn: DESC, createTime: ASC}) {\n    aliases\n    pool\n    name\n    uuid\n    namePinyin\n    fieldType\n    key\n    defaultValue\n    createTime\n    hidden\n    required\n    canUpdate\n    builtIn\n    allowEmpty\n    options {\n      uuid\n      value\n      color\n      bgColor\n    }\n    testcaseFieldConfigs(filter: $configFilter, orderBy: {namePinyin: ASC}) {\n      key\n      uuid\n      name\n      namePinyin\n    }\n  }\n}\n",
                        "variables": {
                            "testCaseFilter": [{
                                "testcasePlan_in": [caseUuid],
                                "testcaseCase": {}
                            }],
                            "planFilter": {
                                "uuid_in": [caseUuid]
            ...
            self.logger.error(f'getCaseDetails:{e}')

    def getCaseRefId(self,caseUuid:str):
        """
        获取case ref_id
        :param caseUuid:
        :return:
        """
        try:
            inCaseUUID = self.getCaseDetails(caseUuid)['data']['buckets'][0]['testcasePlanCases'][0]['inCaseUUID']
            return inCaseUUID
        except BaseException as e:
            self.logger.error(f'getCaseRefId:{e}')
    ...
    def getProjectTaskTransitions(self,task_uuid)->dict:
        ...
        try:
            ...
            for module in task_Transitions_info['field_values']: # 遍历所有模块的值
                ...
                if module['field_uuid'] == 'HsEQmwes': # 用例重复执行次数
                    repeatNumber = module['value']
                if module['field_uuid'] == 'zTD1tRfa': # 应用类型
                    type = module['value']
                    if type == 'Wc5toqo9':
                        type = 'SROS'
                    elif type == 'WS6SqWnE':
            ...
            task_Transitions_Info = {
                ...
                'repeatNumber' : repeatNumber, # 用例重复执行次数
                'type' : type, # 应用类型
    ...
    def update_ProjectTask_field_values(self,task_uuid:str,field_values:dict):
        ...
        try:
            ...
            self.logger.error(f'update_ProjectTask_field_values:{e}')
    ...
    def update_ProjectTask_Status(self,task_uuid:str,status:str):
        ...
        try:
            ...
            self.logger.error(f'update_ProjectTask_Status:{e}')
    ...
    def addTestReport(self,testPlanUuid:str,reportName:str,start_time=0):
        """
        新增测试报告
        :param testPlanUuid:
        :param reportName:
        ...
        try:
            ...
            request = {
                        "query": "\n        mutation ADD_TEST_REPORT {\n          addTestcaseReport (name: $name description: $description testcase_plans: $testcase_plans) {\n            key\n          }\n        }\n      ",
                        "variables": {
                            "name": reportName,
                            "description": "{\"components\":[\"1\",\"2\",\"3\",\"4\",\"5\"],\"contentMap\":{\"richTextComponentTitleSet\":{},\"richTextComponentContentSet\":{}}}",
                            "testcase_plans": [testPlanUuid]
                        }
                    }
            ret = requests.post(url=request_URL, headers=headers, json=request)
            retReport = str(ret.json()['data']['addTestcaseReport']['key'])
            reportUuid = retReport[retReport.find('-')+1:] # 输出报告uuid
            self.updateReport(reportName,reportUuid,start_time)
            return reportUuid # {'data': {'addTestcaseReport': {'key': 'testcase_report-AtpmiPu6'}}}
        except BaseException as e:
            self.logger.error(f'addTestReport:{e}')

    def updateReport(self,title:str,reportUuid:str,start_time=0,end_time=0):
        """
        更新测试报告：保留概览、测试用例结果分布、测试用例所属模块分布
        :param title: 测试报告标题
        :param reportUuid: 测试报告uuid
        :param start_time: 开始时间,o:未设置
        :param end_time: 结束时间
        :return:
        """
        try:
            request_URL = 'https://ones.standard-robots.com/project/api/project/team/{teamUUID}/testcase/report/{reportUuid}/update_report'.format(
                teamUUID=self.teams_uuid,reportUuid=reportUuid)
            headers = {
                'Ones-Auth-Token': self.user_token,
                'Ones-User-Id': self.user_uuid,
            }
            request = {
                        "uuid": reportUuid,
                        "start_time": start_time, # 可以更改时间
                        "end_time": end_time,
                        "title": title,
                        "summary": "{\"components\":[\"1\",\"2\",\"4\"],\"contentMap\":{\"richTextComponentTitleSet\":{},\"richTextComponentContentSet\":{}}}"
                    }
            ret = requests.post(url=request_URL, headers=headers, json=request)
            return ret.status_code
        except BaseException as e:
            self.logger.error(f'updateReport:{e}')

    def downloadReport(self,reportUuid:str,title:str):
        """
        下载测试报告
        :param reportUuid: 测试报告uuid
        :param title: 测试报告标题
        ...
        """
        try:
            url = f'https://ones.standard-robots.com/project/api/project/team/{self.teams_uuid}/testcase/report/{reportUuid}/download'
            ret = requests.get(url=url, stream=True)
            with open('{0}{1}'.format(self.fileDownloadPath, title), 'wb') as code:
                for chunk in ret.iter_content(chunk_size=512):
                    code.write(chunk)
            self.logger.info('{} download completed!'.format(title))
        except BaseException as e:
            self.logger.error(f'downloadReport:{e}')

    def reportShareLink(self,testPlanUuid:str,reportUuid:str):
        """
        测试报告链接分享URL
        ...
        :return:
        """
        linkUrl = f'https://ones.standard-robots.com/project/#/testcase/team/{self.teams_uuid}/report/{reportUuid}?backUrl=/testcase/team/{self.teams_uuid}/plan/{testPlanUuid}/library'
        return linkUrl

    def deleteReport(self,reportUuid:str):
        """
        删除测试报告
        :param reportUuid:
        :return:
        ...
        try:
            ...
            request = {
                        ...
                        "variables": {
                            "key": f"testcase_report-{reportUuid}"
                        }
                    }
            ret = requests.post(url=request_URL, headers=headers, json=request)
            return ret.status_code
        except BaseException as e:
            self.logger.error(f'deleteReport:{e}')
