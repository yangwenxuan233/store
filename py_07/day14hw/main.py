...
def send_email(name):
    ...
    receiver = '1282398184@qq.com'  # '2431320433@qq.com'
    mail_title = '银行系统测试用例执行结果'
...
run_case(r"D:\pscode\demo\day14hw", "TestBank.py", "Bank")
