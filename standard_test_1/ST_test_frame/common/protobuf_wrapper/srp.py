...
class SRP:
    ...
    def set_manual(self):
        self._run_sync_threadsafe(self._protobuf.set_manual_control)
    ...
    def reset_sros(self):
        # resetSROS
        self._run_sync_threadsafe(self._protobuf.resetSROS)
...
if __name__ == '__main__':
    ...
    try:
        srp = SRP()
        srp.login('192.168.33.21', 'dev', '_sr_dev_')
        # srp.reset_sros()
        # srp.triger_emergency()
        srp.cancel_emergency()
        # print(srp.set_manual())
        # srp.move_to_station(1, 2)
