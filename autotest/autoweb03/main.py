...
# 向报告中添加截图
# def add_image(excel_path, image_path, name):
...
# run_case(r"D:\pycode\autoweb\autoweb03", "login")
# add_image(r"D:\pycode\login.xlsx", r"D:\pycode\py202107\day15hw\image\大美女.jpg", "login_screenshot")
